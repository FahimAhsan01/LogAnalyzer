...
def export_metadata_to_duckdb(documents, duckdb_path, table_name="vector_metadata"):
    rows = []
...
def main():
    ...
    export_metadata_to_duckdb(new_documents, duckdb_path, table_name="vector_chunks")
